...
|---|---|---|
| New website or app | `brainstorming` skill → `website-build-protocol` category | See website build protocol |
| New landing page | `landing-page-generator` skill | `tailwind-patterns`, `shadcn` |
| UI component | `ui-ux-pro-max` skill | `shadcn`, `react-best-practices` |
| Next.js feature | `nextjs-best-practices` skill | `nextjs-app-router-patterns` |
...
| Dark/premium UI | `industrial-brutalist-ui` or `frontend-ui-dark-ts` | `tailwind-design-system` |
| Design system | `tailwind-design-system` skill | `shadcn`, `ui-tokens` |
| Mobile UI | `mobile-design` skill | `hig-platforms` |
